...
1. Класс Company: Этот класс, который содержит общие атрибуты и методы для сотрудников компании. Он включает в себя информацию о сотрудниках, методы для отображения информации, обновления зарплаты, повышения и отображения отдела.
